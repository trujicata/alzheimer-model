...
weights = torch.load('models/weights/Genesis_Chest_CT_encoder.pt', map_location=torch.device('cpu'))
...
class Decoder(nn.Module):
    def __init__(self):
        ...
        self.deconv1 = nn.ConvTranspose3d(2048, 1024, kernel_size=4, stride=2, padding=1, output_padding=1)
        self.deconv2 = nn.ConvTranspose3d(1024, 512, kernel_size=3, stride=2, padding=1, output_padding=1)
        self.deconv3 = nn.ConvTranspose3d(512, 512, kernel_size=(6,4,4), stride=2, padding=2, output_padding=1)
...
out1 = autoencoder.encoder(out)
print("Encoder output shape:")
print(out1.shape)

out2 = autoencoder(out)
